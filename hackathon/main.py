...
class App(CTk.CTk):
    def __init__(self):
        ...
        self.btn_quit = CTk.CTkButton(master=self.settings_frame, text="QUIT", width=100, command=self.quit)
        self.btn_quit.grid(row=4, column=0, columnspan=4, pady=(10, 10))
